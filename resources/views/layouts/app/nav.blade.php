            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <i class="bx bx-user me-2"></i><span key="t-dashboards">Students</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <i class="bx bx-file me-2"></i><span key="t-extra-pages">Academic Management</span> <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="{{ route('class.index') }}" id="topnav-invoice"
                                    role="button">
                                    <span key="t-invoices">Classes</span>
                                </a>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-invoice"
                                    role="button">
                                    <span key="t-invoices">Divisions</span>
                                </a>
                            </div>
                        </div>
                    </li>
